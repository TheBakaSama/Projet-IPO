...
public class Game {
	...
	public void update() {
		...
		if (testLose())
			if (environment.getClass() == EnvInf.class) graphic.endGameScreen("You Loose :/\nYour Point: " + frog.getScore());
			else graphic.endGameScreen("You Loose");
		if (testWin()) graphic.endGameScreen("Congratulation");
	}
